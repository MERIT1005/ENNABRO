...
bot = telebot.TeleBot('7731726163:AAGE5fErQkOWZDZRCuRPatl2kYwFggkwOoo')
...
@bot.message_handler(commands=['VICKY'])
    ...
    if user_id in allowed_user_ids:
        ...
        if user_id not in admin_id:
            ...
            if user_id in TOXIC_cooldown and (datetime.datetime.now() - TOXIC_cooldown[user_id]).seconds < 3:
                response = "You Are On Cooldown . Please Wait 60seconds Before Running The /VICKY Command Again."
                bot.reply_to(message, response)
                return
        ...
        if len(command) == 4:  # Updated to accept target, time, and port
            ...
            response = "✅VICKY PAID Ɗᴅㅇ𝕊 𝗔𝗖𝗧𝗜𝗩𝗘 ✅\n\n/VICKY <ϯ𝘢𝒓ᶢ𝘦ϯ> <𝕡𝐨𝒓ϯ> <тᶦм𝒆>\n\nATTACK KAREGA TOH FEEDBACK DENA\n\nhttps://t.me/+8j8MANpH8-A3MDll"  # Updated command syntax
    else:
        response = " LAWDE BAAP KO MSG KARDM - @Vickyoct2k08 ."
...
def welcome_start(message):
    ...
    response = f'''ıllıllı⭐🌟 WELCOME TO VICKY BOT {user_name}! 🌟⭐ıllıllı\n \nıllıllı⭐🌟 BGMI KI CHUDAYI KARO 🌟⭐ıllıllı\n\n
🤖LAWDE YE USE KAR KE ATTACK KAR: /VICKY\n\nhttps://t.me/+8j8MANpH8-A3MDll
'''
    bot.reply_to(message, response)
